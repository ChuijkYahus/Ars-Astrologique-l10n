...
public class GlyphStalwart extends AbstractEffect implements IPotionEffect {
    public static GlyphStalwart INSTANCE = new GlyphStalwart(prefix("glyph_stalwart"), "Stalwart");

    public GlyphStalwart(ResourceLocation tag, String description) {
    ...
    public void onResolveEntity(EntityHitResult rayTraceResult, Level world, @NotNull LivingEntity shooter, SpellStats spellStats, SpellContext spellContext, SpellResolver resolver) {
        if(rayTraceResult.getEntity() instanceof LivingEntity living){
            this.applyConfigPotion(living, AstroEffectRegistry.STALWART_EFFECT, spellStats, true);
        }
    }
