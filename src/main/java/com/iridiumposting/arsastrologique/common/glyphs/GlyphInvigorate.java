...
public class GlyphInvigorate extends AbstractEffect implements IPotionEffect {
    public static GlyphInvigorate INSTANCE = new GlyphInvigorate(prefix("glyph_invigorate"), "Invigorate");

    public GlyphInvigorate(ResourceLocation tag, String description) {
    ...
    public Set<SpellSchool> getSchools() {
        return setOf(SpellSchools.NECROMANCY, SpellSchools.ABJURATION);
    }
