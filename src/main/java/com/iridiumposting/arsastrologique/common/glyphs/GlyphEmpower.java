...
public class GlyphEmpower extends AbstractEffect implements IPotionEffect {
    public static GlyphEmpower INSTANCE = new GlyphEmpower(prefix("glyph_empower"), "Empower");

    public GlyphEmpower(ResourceLocation tag, String description) {
        super(tag, description);
    }

    @Override
    public void onResolveEntity(EntityHitResult rayTraceResult, Level world, @NotNull LivingEntity shooter, SpellStats spellStats, SpellContext spellContext, SpellResolver resolver) {
        if(rayTraceResult.getEntity() instanceof LivingEntity living) this.applyConfigPotion(living, AstroEffectRegistry.EMPOWER_EFFECT, spellStats, true);
    }
